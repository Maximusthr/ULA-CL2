...
O arquivo Waveform para simulação das operações aritméticas está em: [`Operações Aritméticas`](Operacoes%20Aritmeticas/)

### Simulação de Operações Lógicas

![image](https://github.com/user-attachments/assets/a3309229-8186-428a-a1b4-09fcfa8a4aef)

O arquivo Waveform para simulação das operações lógicas está em: [`Operações Lógicas`](Operacoes%20Logicas/)
